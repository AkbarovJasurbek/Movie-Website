window.addEventListener('DOMContentLoaded', () => {
    ...
    render() {
      ...
      element.innerHTML = `
        ...
        <div class="menu__item-price">
          ...
          <div class="menu__item-total"><span>${this.price}</span> won/month</div>
        </div>
      `
  ...
  if (slides.length < 20) {
    ...
    total.textContent = sldies.length
  ...
  //   if (slides.length < 10) {
  //     current.textContent = `0${slidexIndex}`
  //   } else {
  //     current.textContent = slidexIndex
  //   }
  // }
  // function plusSlides(idx) {
  //   showSlides((slidexIndex += idx))
  // }
